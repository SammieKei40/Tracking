...
<?php
    ...
    $result=mysql_query("SELECT * FROM news WHERE newsid={$_GET['newsid']};");
	$row=mysql_fetch_array($result);
    
	$formtitle=$row["title"];
	$formheadline=$row["headline"];
	$formcontent=$row["content"];
	$formdate=$row["date"];
	$formnewsid=$row["newsid"];
...
<td colspan="4">
  ...
  <br><center>
	<form  action="./confirmnews.php?newsid=<?echo $formnewsid;?>" method="post">
	<table>
    <tr>
	<td align=right><font face=verdana size=2 color=blue>TITLE:</font></td>
	<td><input type="text" name="title" value="<? echo $formtitle;?>" size=50></td>
	</tr>
	<tr>
	<td align=right ><font face=verdana size=2 color=blue >DATE:</font></td>
	<td><input type="text" name="date" value="<? echo $formdate;?>" size=50></td>
	</tr>
	<tr>
	<td align=right ><font face=verdana size=2 color=blue >HEADLINE:</font></td>
	<td><input type="text" name="headline" style="height:100;width:325" value="<? echo $formheadline;?>" size=50></td>
	</tr>
	<tr>
	<td align=right ><font face=verdana size=2 color=blue >CONTENT:</font></td>
	<td><input type="text" name="content" style="height:300;width:325" value="<? echo $formcontent;?>" size=50></td>
	</tr>
		</tr>
    ...
    <tr>
 	  ...
 	  <td align=center><input type=button value="CANCEL" style="background-color:SpringGreen;height:20;width:160;color:Black;"ONMOUSEOVER="this.style.border='5px solid #87CEEB'"ONMOUSEOUT="this.style.border='2px solid #708090'"ONCLICK="window.location.href='./admin.php'">
 	  </td>
 	</tr>
    </table>
  </form>
