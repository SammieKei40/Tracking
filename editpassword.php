...
<?php
    ...
    $result=mysql_query("SELECT * FROM admintable WHERE id={$_GET['id']};");
...
<td colspan="4">
  ...
  <br><center>
	<form  action="./confirmpassword.php?id=<?echo $formid;?>" method="post">
	<table>
    
	<tr>
	<td align=right><font face=verdana size=2 color=blue>USERNAME:</font></td>
	<td><input type="text" name="username" value="<? echo $formusername;?>" size=50></td>
	</tr>
	
	<tr>
	<td align=right ><font face=verdana size=2 color=blue >PASSWORD:</font></td>
	<td><input type="text" name="password" value="<? echo $formpassword;?>" size=50><br><br></td>
	</tr>

	<tr>
	<td align=right ><font face=verdana size=2 color=blue >Type:</font></td>
	<td><select name="utype" value="<? echo $formutype;?>" size=5> 
	
	<option value="Primary" SELECTED>Primary Administrator</option>
	<option value="Secondary"><b>Secondary Administrator</option>
	<br><br></td>
	</tr>
