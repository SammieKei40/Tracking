...
<?php 
	...
	$id=$_GET['id'];
		$sql = "UPDATE admintable
			   SET username='$username',password='$password',utype='$utype' 
			   WHERE id=$id";
		mysql_query($sql);		
	  
	   echo "<table border='1' align='center' bordercolor='GREEN'><td width=300 align=center><p><b><font face='verdana' color='BLUE'><center> RECORD SUCCESSFULLY SAVED!.   </center></td></b></font></table>";
...
<br><br><br>
	<center>
	<input type=button value="BACK" style="background-color:SpringGreen;height:20;width:160;color:Black;"ONMOUSEOVER="this.style.border='5px solid #87CEEB'"ONMOUSEOUT="this.style.border='2px solid #708090'"ONCLICK="window.location.href='./admin.php'">
    </center>
