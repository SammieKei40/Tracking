...
<?php
    ...
    $result=mysql_query("SELECT * FROM proof WHERE proofid={$_GET['proofid']};");
	$row=mysql_fetch_array($result);
    
	$formtrack=$row["track"];
	$formname=$row["name"];
	$formaddress=$row["address"];
	$formproofid=$row["proofid"];
	$formsignature=$row["signature"];
...
<td colspan="4">
  ...
  <br><center>
	<form  action="./confirmproof.php?proofid=<?echo $formproofid;?>" method="post">
	<table>
	
	<tr>
	<td align=right><font face=verdana size=2 color=blue>TRACKING #:</font></td>
	<td><input type="text" name="track" value="<? echo $formtrack;?>" size=50></td>
	</tr>
	
    <tr>
	<td align=right><font face=verdana size=2 color=blue>NAME:</font></td>
	<td><input type="text" name="name" value="<? echo $formname;?>" size=50></td>
	</tr>
	
	<tr>
	<td align=right ><font face=verdana size=2 color=blue >ADDRESS:</font></td>
	<td><input type="text" name="address" value="<? echo $formaddress;?>" size=50><br><br></td>
	</tr>
	
	<tr>
	<td align=right ><font face=verdana size=2 color=blue >SIGANTURE:</font></td>
	<td><input type="file" name="signature" value="<? echo $formsignature;?>" size=50><br><br></td>
	</tr>
